...
export const restaurants: Restaurant[] = [
  ...
  {
    id: "beach-bhavan",
    name: "Beach Bhavan Street Eats",
    category: "streetfood",
    description: "The most popular street-food stalls near the beach – cheap, delicious, and authentic.",
    image: "https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=800&q=80",
    priceRange: "100-300",
    rating: 4.3,
    reviews: 1200,
    popularDishes: ["Shawarma", "Chicken Parotta", "Vada Pav", "Masala Tea"],
    location: { lat: 8.7375, lng: 76.7162 },
    address: "Beach Road, Varkala",
    tags: ["Street Food", "Budget", "Must Try", "Late Night"],
    crowdLevel: "high",
